...
export const GLOSSARY: Record<string, string> = {
  ...
  "P&L": "Profit & Loss (Lucro e Prejuízo): diferença entre o valor atual da posição e o total investido. Positivo = lucro; negativo = prejuízo. Como a posição ainda está aberta, o resultado pode mudar com as variações de preço.",
  ...
  "Lucro / Prejuízo": "Diferença entre o valor atual da carteira e o total investido. Positivo = lucro; negativo = prejuízo. Como as posições ainda estão abertas, o resultado pode mudar com as variações de preço.",
  ...
  "Variação": "Diferença entre o valor atual das posições e o total investido, em percentual e em reais. Não inclui proventos recebidos — apenas a mudança de preço dos ativos.",
  "Rentabilidade": "Retorno total da carteira: variação de preço + proventos recebidos, dividido pelo total investido.",
  "Variação e Rentabilidade": "Variação = apenas mudança de preço dos ativos. Rentabilidade = variação + proventos recebidos. A rentabilidade é sempre maior ou igual à variação.",
